 ...
 */
  ...
  class DomXSLProcessor extends Object implements IXSLProcessor {
     ...
     * @return  
     */
    public function setXSLDocument(DOMDocument $d) {
      $this->stylesheet= $d;
      $this->_checkErrors();
    }    
     ...
     * @return  
     */
    public function addPreprocessAnalyzer(XslAnalyzer $a) {
      $this->analyzers[]= $a;
    }
     ...
     * @return  
     */
    public function invokePreprocessAnalyzers(DOMDocument $d) {
    ...
    public function run() {
      ...
      // Invoke pre-process interceptors
      $this->invokePreprocessAnalyzers($this->stylesheet);
      ...
      // Invoke post-process analyzer
      // $this->invokePostprocessAnalyzer();
