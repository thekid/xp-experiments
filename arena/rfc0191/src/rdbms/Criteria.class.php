 ...
 */
  ...
  class Criteria extends Object implements SQLExpression {
    ...
    /**
     * Binds a query parameter to a given value
     *
     * @param   var value
     * @return  rdbms.Criteria this
     */
    public function bind($value) {
      foreach ($this->conditions as $i => $condition) {
        if (!$condition->value instanceof QueryParameter) continue;
        $condition->value= $value;
        return $this;
      }
      throw new IllegalStateException('Nothing to bind to');
    }
