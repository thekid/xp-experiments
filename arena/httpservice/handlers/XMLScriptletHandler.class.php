 ...
 */
  ...
  uses('scriptlet.xml.workflow.AbstractXMLScriptlet', 'handlers.AbstractUrlHandler');
   ...
   */
  class XMLScriptletHandler extends AbstractUrlHandler {
     ...
     */
    public function __construct($package, $xslpath) {
      $this->scriptlet= new AbstractXMLScriptlet($package, $xslpath);
      $this->scriptlet->init();
    }
    ...
    public function handleRequest($method, $query, array $headers, $data, Socket $socket) {
      ...
      $request= new WorkflowScriptletRequest($this->scriptlet->package);
      ...
      // Create 
      $response= new XMLScriptletResponse($this->scriptlet->processor);
