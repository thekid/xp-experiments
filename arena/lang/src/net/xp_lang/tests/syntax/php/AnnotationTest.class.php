 ...
 */
   ...
   *
   */
  class net·xp_lang·tests·syntax·php·AnnotationTest extends net·xp_lang·tests·syntax·php·ParserTestCase {
    ...
    protected function parseMethodWithAnnotations($annotations) {
      return create(new xp·compiler·syntax·php·Parser())->parse(new xp·compiler·syntax·php·Lexer('<?php abstract class Container {
        '.$annotations.'
    ...
    /**
     * Test annotation with key/value pairs (Expect(class net·xp_lang·tests·syntax·php·es = [...], code = 503))
     *
     */
    #[@test]
