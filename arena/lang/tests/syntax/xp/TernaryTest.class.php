  ...
  class TernaryTest extends ParserTestCase {
    ...
    public function ternary() {
      $this->assertEquals(array(new TernaryNode(array(
        ...
        'expression'    => new IntegerNode(array('position' => array(4, 14), 'value' => '1')),
        'conditional'   => new IntegerNode(array('position' => array(4, 18), 'value' => '2')),
      ))), $this->parse('
        $i ? 1 : 2;
      '));
    }
    ...
    public function assignment() {
      $this->assertEquals(array(new AssignmentNode(array(
        ...
        'expression'    => new TernaryNode(array(
          ...
          'conditional'   => new IntegerNode(array('position' => array(4, 30), 'value' => '1'))
        )),
        'op'            => '='
      ))), $this->parse('
        $a= $argc ? $args0 : 1;
    ...
    public function withoutExpression() {
      $this->assertEquals(array(new TernaryNode(array(
        ...
        'condition'     => $this->create(new VariableNode('i'), array(4, 9)),
        'expression'    => NULL,
        'conditional'   => new IntegerNode(array('position' => array(4, 15), 'value' => '2')),
      ))), $this->parse('
        $i ?: 2;
      '));
    }
    ...
    public function nested() {
      $this->assertEquals(array(new TernaryNode(array(
        ...
        'conditional'   => new TernaryNode(array(
          ...
          'expression'    => new IntegerNode(array('position' => array(4, 21), 'value' => '1')),
          'conditional'   => new IntegerNode(array('position' => array(4, 25), 'value' => '2')),
        ))
      ))), $this->parse('
        $i ?: ($f ? 1 : 2);
      '));
