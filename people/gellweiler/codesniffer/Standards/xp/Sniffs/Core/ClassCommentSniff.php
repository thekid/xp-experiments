...
if (class_exists('PHP_CodeSniffer_Standards_xp_parser_ClassCommentParser', true) === false) {
    $error = 'Class PHP_CodeSniffer_Standards_xp_parser_ClassCommentParser not found';
...
class xp_Sniffs_Core_ClassCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
       ...
       // var_dump($commentEnd);
        ...
        try {
            $this->commentParser = new PHP_CodeSniffer_Standards_xp_parser_ClassCommentParser($comment, $phpcsFile);
