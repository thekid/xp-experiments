...
.    * @return  mixed result of the last reduction, if any.
    ...
    case 1:  #line 30 "grammar/Class.jay"
    ...
    case 11:  #line 59 "grammar/Class.jay"
    {
    $yyVal= $yyVals[0+$yyTop];
    $yyVal->setAnnotation($yyVals[-2+$yyTop]);
    isset($yyVals[-1+$yyTop]['abstract']) && $yyVal->setAbstract($yyVals[-1+$yyTop]['abstract']);
    ...
    case 12:  #line 66 "grammar/Class.jay"
    {
    $yyVal= $yyVals[0+$yyTop];
    isset($yyVals[-1+$yyTop]['abstract']) && $yyVal->setAbstract($yyVals[-1+$yyTop]['abstract']);
    isset($yyVals[-1+$yyTop]['scope'])    && $yyVal->setScope($yyVals[-1+$yyTop]['scope']);
    ...
    case 18:  #line 87 "grammar/Class.jay"
    { $yyVal= $yyVals[-1+$yyTop];} break;

    case 19:  #line 88 "grammar/Class.jay"
    { $yyVal= array(); } break;

    case 20:  #line 91 "grammar/Class.jay"
    { $yyVal= $yyVals[-2+$yyTop]; $yyVal[]= $yyVals[0+$yyTop]; } break;

    case 21:  #line 92 "grammar/Class.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;
    ...
    case 52:  #line 162 "grammar/Class.jay"
    { $yyVal= array_merge($yyVals[-2+$yyTop], $yyVals[-1+$yyTop]); } break;

    case 53:  #line 163 "grammar/Class.jay"
    ...
    case 54:  #line 164 "grammar/Class.jay"
    { $yyVal= $yyVals[-1+$yyTop]; } break;

    case 55:  #line 168 "grammar/Class.jay"
    { $yyVals[-2+$yyTop][]= $yyVals[0+$yyTop]; $yyVal= $yyVals[-2+$yyTop];} break;

    case 56:  #line 169 "grammar/Class.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 57:  #line 173 "grammar/Class.jay"
    { $yyVal= new xp·ide·source·element·Classmember(substr($yyVals[-2+$yyTop]->getValue(), 1), NULL, $yyVals[0+$yyTop]); } break;

    case 58:  #line 174 "grammar/Class.jay"
    ...
    case 63:  #line 188 "grammar/Class.jay"
    { $yyVal= xp·ide·source·Scope::$PUBLIC; } break;

    case 64:  #line 189 "grammar/Class.jay"
    { $yyVal= xp·ide·source·Scope::$PRIVATE; } break;

    case 65:  #line 190 "grammar/Class.jay"
    { $yyVal= xp·ide·source·Scope::$PROTECTED; } break;

    case 66:  #line 194 "grammar/Class.jay"
    { $yyVal= $yyVals[0+$yyTop]->getValue(); } break;

    case 67:  #line 195 "grammar/Class.jay"
    { $yyVal= $yyVals[0+$yyTop]->getValue(); } break;

    case 68:  #line 196 "grammar/Class.jay"
    { $yyVal= $yyVals[0+$yyTop]->getValue(); } break;

    case 69:  #line 197 "grammar/Class.jay"
    { $yyVal= $yyVals[0+$yyTop]->getValue(); } break;

    case 70:  #line 201 "grammar/Class.jay"
    { $yyVal= new xp·ide·source·element·Array($yyVals[-2+$yyTop]); } break;

    case 71:  #line 202 "grammar/Class.jay"
    { $yyVal= new xp·ide·source·element·Array($yyVals[-1+$yyTop]); } break;

    case 72:  #line 203 "grammar/Class.jay"
    { $yyVal= new xp·ide·source·element·Array(); } break;

    case 73:  #line 204 "grammar/Class.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 74:  #line 208 "grammar/Class.jay"
    { $yyVals[-4+$yyTop][$yyVals[-2+$yyTop]]= $yyVals[0+$yyTop]; $yyVal= $yyVals[-4+$yyTop]; } break;

    case 75:  #line 209 "grammar/Class.jay"
    { $yyVals[-2+$yyTop][]= $yyVals[0+$yyTop]; $yyVal= $yyVals[-2+$yyTop]; } break;

    case 76:  #line 210 "grammar/Class.jay"
    { $yyVal= array($yyVals[-2+$yyTop] => $yyVals[0+$yyTop]); } break;

    case 77:  #line 211 "grammar/Class.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;
#line 626 "-"
            }
