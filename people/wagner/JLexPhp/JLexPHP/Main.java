...
class CEmit
{
  ...
  m_outstream.print("  class {%CLASSNAME%} extends {%PARENTNAME%} ");
  ...
  // modified to use int[][] unpackFromString(int size1, int size2, String st)
...
private void emit_table_as_array_2d(int [][] ia) {
      ...
      throws java.io.IOException
  {
    ...
    m_outstream.print("  protected function yylex()");
